...
export const metadata: Metadata = {
  ...
  description: 'Understand the principles of a Technology Radar, its structure, and how it helps in making strategic technology decisions for your organization.',
};
